      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(user, {
            ...
            photoURL: "https://avatars.githubusercontent.com/u/98372553?v=4"
          })
            .then(() => {
  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-3/12 absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white bg-opacity-45">
